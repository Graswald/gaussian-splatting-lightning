...
def generate_appearance_group(workspace: Path) -> None:
    camera_json_file = workspace / "ns" / "transforms.json"
    cameras = read_json_file(file_path=camera_json_file.as_posix())
    image_group = {}
    ...
    save_path = workspace / "appearance_groups.json"
